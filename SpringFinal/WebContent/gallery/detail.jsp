...
<div class="container">
  <form>
  	<input type="hidden" id="gallery_id" name="gallery_id" value="<%=gallery.getGallery_id()%>">
  	<input type="hidden" id="filename" name="filename" value="<%=gallery.getFilename()%>">
    <input type="text" id="title" name="title" value="<%=gallery.getTitle()%>">
    <input type="text" id="writer" name="writer" value="<%=gallery.getWriter()%>">
